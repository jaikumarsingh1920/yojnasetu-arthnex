...
export const BlogReader: React.FC = () => {
  ...
  if (loading) return <div className="mx-auto max-w-xl p-12 text-center text-slate-500">Loading story...</div>;
  if (!blog) return <div className="mx-auto max-w-xl p-12 text-center text-slate-500">This story could not be found.</div>;
