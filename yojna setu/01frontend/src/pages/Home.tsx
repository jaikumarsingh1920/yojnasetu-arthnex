  ...
  return (
    <div className="space-y-12 sm:space-y-16 lg:space-y-20 pb-20 bg-[#FFFBF0] text-[#3B2522] min-h-screen">
      ...
      {/* ============================================================
          ...
          4 distinct modern civic cards with colored icon tiles
          ============================================================ */}
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-6 sm:-mt-8 relative z-30">
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
          {/* Stat 1: Verified Schemes */}
          <div className="bg-white rounded-2xl border border-[#E8D8D2] shadow-warm-xs hover:shadow-warm-md transition p-6 flex flex-col items-center text-center group">
            <div className="w-12 h-12 rounded-xl bg-[#FFF4EC] text-[#F7AE56] border border-[#FFD0CA] flex items-center justify-center mb-3.5 group-hover:scale-105 transition-transform">
              <BookOpen className="w-6 h-6" />
            </div>
            <div className="text-3xl sm:text-4xl lg:text-5xl font-black text-[#3B2522] tracking-tight">
              {stats.totalSchemes}+
            </div>
            <div className="mt-1.5 text-sm font-bold text-[#3B2522]">
              {t('home.stat1Label', 'Verified Schemes')}
            </div>
            <div className="text-xs text-[#765E59] mt-0.5">{t('home.schemesActiveSub', 'Central & State Portfolios')}</div>
          </div>
          ...
          <div className="bg-white rounded-2xl border border-[#E8D8D2] shadow-warm-xs hover:shadow-warm-md transition p-6 flex flex-col items-center text-center group">
            ...
            <div className="mt-1.5 text-sm font-bold text-[#3B2522]">
              {t('home.stat2Label', 'Partner Records')}
            </div>
            <div className="text-xs text-[#765E59] mt-0.5">{t('home.stat2Sub', 'Banks, SCAs & Centers')}</div>
          </div>

          {/* Stat 3: Indian Languages */}
          <div className="bg-white rounded-2xl border border-[#E8D8D2] shadow-warm-xs hover:shadow-warm-md transition p-6 flex flex-col items-center text-center group">
            <div className="w-12 h-12 rounded-xl bg-[#FFF4EC] text-[#EA717B] border border-[#FFD0CA] flex items-center justify-center mb-3.5 group-hover:scale-105 transition-transform">
              <Globe2 className="w-6 h-6" />
            </div>
            <div className="text-3xl sm:text-4xl lg:text-5xl font-black text-[#EA717B] tracking-tight">
              {stats.languages}
            </div>
            <div className="mt-1.5 text-sm font-bold text-[#3B2522]">
              {t('home.languagesSupported', 'Indian Languages')}
            </div>
            <div className="text-xs text-[#765E59] mt-0.5">{t('home.languagesSub', 'Regional Inclusion')}</div>
          </div>
          ...
          <div className="bg-white rounded-2xl border border-[#E8D8D2] shadow-warm-xs hover:shadow-warm-md transition p-6 flex flex-col items-center text-center group">
            ...
            <div className="text-3xl sm:text-4xl lg:text-5xl font-black text-[#F7AE56] tracking-tight">
              3,073+
            </div>
            <div className="mt-1.5 text-sm font-bold text-[#3B2522]">
              Verified Records
            </div>
            <div className="text-xs text-[#765E59] mt-0.5">RBI & Public Disclosures</div>
          </div>
        </div>
      </section>
          ...
          {[
            {
              ...
              desc: 'Share basic details like state, category, age, and employment status in complete privacy.',
              icon: FileText,
            ...
            },
            {
              ...
              desc: 'Our deterministic rule engine evaluates statutory Gazette criteria against your profile.',
              icon: ShieldCheck,
            ...
            },
            {
              ...
              desc: 'Receive a curated list with clear match reasons, loan ceilings, and capital subsidies.',
              icon: Sparkles,
              tileClass: 'bg-[#FFF4EC] text-[#F7AE56] border-[#FFD0CA]',
            },
            {
              step: '04',
              title: 'Apply Through Official Route',
              desc: 'Apply directly on verified Ministry portals or visit nearest authorized assistance centers.',
              icon: MapPin,
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 border-b border-[#E8D8D2]/60 pb-6">
            <div className="space-y-1.5 text-left max-w-2xl">
              ...
              <p className="text-sm sm:text-base text-[#765E59] leading-relaxed">
                Integrated civic tools designed to eliminate guesswork, middle-men, and misinformation.
              </p>
            </div>
            <Link
              to="/schemes"
            ...
            {[
              {
                ...
                desc: `Search and filter ${stats.totalSchemes}+ verified central and state welfare portfolios by ministry, sector, and beneficiary.`,
                link: '/schemes',
              ...
              },
              {
                icon: ShieldCheck,
                title: 'Check Eligibility',
                desc: 'Audited deterministic rules evaluate your age, income, and category against official Gazette criteria without document uploads.',
                link: '/schemes',
              ...
              },
              {
                ...
                desc: 'Describe your business or situation in conversational natural language to receive high-precision potential scheme matches.',
              ...
              },
              {
                ...
                desc: 'Simulate loan EMIs, interest liabilities, capital subsidies, and evaluate household repayment affordability.',
                link: '/calculator',
                tileClass: 'icon-tile-orange',
              },
              {
                ...
                desc: 'Statutory transparency on channel partner banks, regional rural banks, and prudential delivery capacity.',
              ...
              },
              {
                ...
                desc: 'Locate verified bank branches, State Channelizing Agencies, and facilitation centres near your district or PIN code.',
          ...
          <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4">
            <div>
              <div className="inline-flex items-center gap-2 bg-[#FFF4EC] text-[#EA717B] text-xs font-bold px-3 py-1 rounded-full uppercase tracking-wider border border-[#FFD0CA] mb-2">
                High Citizen Relevance
              </div>
              <h2 className="text-2xl sm:text-3xl font-black text-[#3B2522] tracking-tight">
                Popular & Featured Schemes
              </h2>
              <p className="text-sm text-[#765E59] mt-1">
                Active government initiatives with statutory funding allocations and direct assistance.
              </p>
            </div>
            <Link
              to="/schemes"
          ...
          <div className="relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            ...
            <div className="lg:col-span-7 space-y-4 text-left">
              ...
              <div className="pt-3">
                <Link
                  to="/recommendations"
                  className="btn btn-lg btn-primary shadow-warm-md"
                >
                ...
                <div className="bg-[#4A2525]/90 p-3.5 rounded-xl border border-[#FFD0CA]/15 flex items-start gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center justify-between">
                      ...
                      <span className="text-xs font-bold text-[#FFD0CA]">28 Yrs • Maharashtra • SC</span>
                    </div>
        ...
        <div className="bg-white rounded-3xl p-6 sm:p-10 border border-[#E8D8D2] shadow-warm-sm space-y-6">
          <div className="max-w-2xl space-y-1.5 text-left">
            ...
            <p className="text-base text-[#765E59] leading-relaxed">
              Ask YojnaSetu in your own words and get grounded guidance backed by official notifications.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-5">
            {[
              {
                query: 'Which schemes can help me start a business?',
                desc: 'PMEGP, MUDRA, Stand-Up India loan & subsidy guidance',
              },
              {
                query: 'Am I eligible for a loan without collateral?',
                desc: 'CGTMSE and Mudra collateral-free credit rules',
              },
              {
                query: 'What documents do I need for PM Vishwakarma?',
                desc: 'Aadhaar, artisan verification, and trade certificates',
              },
            ].map((item) => (
              <button
                key={item.query}
        ...
        <div className="bg-white rounded-3xl p-6 sm:p-10 border border-[#E8D8D2] shadow-warm-sm space-y-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-5">
            {[
              {
                icon: FileCheck2,
                title: 'Gazette Verified',
                desc: 'Every scheme mapped to published ministry notifications and official source links.',
                color: 'text-[#EA717B]',
              },
              {
                icon: CheckCircle2,
                title: 'Deterministic Rule Engine',
                desc: 'Transparent statutory criteria evaluations with conversational AI assistance without guesswork.',
                color: 'text-[#EA717B]',
              },
              {
                icon: Building2,
                title: 'Authorized Channel Partners',
                desc: '171+ verified state channelizing agencies, bank branches, and facilitation centers.',
                color: 'text-[#F7AE56]',
              },
              {
                icon: ShieldCheck,
                title: 'Privacy First Policy',
                desc: 'Zero PII, Aadhaar numbers, or document uploads required to discover and compare schemes.',
                color: 'text-[#4A2525]',
              },
            ].map((pillar) => {
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-white rounded-3xl p-6 sm:p-10 border border-[#E8D8D2] shadow-warm-sm space-y-6">
          <div className="max-w-3xl space-y-1.5 text-left">
            ...
            <p className="text-base text-[#765E59] leading-relaxed">
              Clear answers about how YojnaSetu works, data privacy, and government application routes.
            </p>
          </div>
          ...
          <div className="space-y-3">
            {[
              {
                q: 'How does YojnaSetu determine my scheme eligibility?',
                a: 'YojnaSetu uses a deterministic rule engine based strictly on published Gazette notifications and Ministry guidelines. When you provide details such as age, state, or enterprise stage, our engine evaluates every statutory rule without speculation or estimation.',
              },
              {
                q: 'Do I need to upload Aadhaar, PAN, or financial documents to search?',
                a: 'No. YojnaSetu has a strict zero-document policy for discovery. You can explore all 859+ schemes, check eligibility, and calculate EMIs without uploading any identity documents or providing sensitive personal information.',
              },
              {
                q: 'Is there any fee or charge to use YojnaSetu or apply for schemes?',
                a: 'Zero. YojnaSetu is a free, open civic-tech platform. Government welfare schemes do not require facilitation fees, and all official application portals linked from YojnaSetu are free to access.',
              },
              {
                q: 'What is the difference between an official portal and a channel partner?',
                a: 'Many schemes allow direct online application on Ministry portals (e.g., Udyam, National Scholarship Portal). For credit and loan subsidy schemes, authorized channel partners (like Public Sector Banks and State Channelizing Agencies) process applications and disburse funds.',
              },
              {
                q: 'How does YojnaSetu ensure that scheme guidelines and subsidies are accurate?',
                a: 'Every scheme record in YojnaSetu is mapped directly to authoritative Gazette notifications, Ministry annual reports, and official RBI data returns. Our provenance system records the source document and last verified date for complete public auditability.',
              },
            ].map((faq, idx) => {
        ...
        <div className="bg-[#4A2525] text-white rounded-3xl p-8 sm:p-12 shadow-warm-xl border border-[#3B2522] flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="space-y-2 text-center md:text-left">
            <h2 className="text-xl sm:text-3xl font-black text-white">
              Your next opportunity may already exist.
            </h2>
            <p className="text-base text-[#FFFBF0]/80 max-w-xl leading-relaxed">
              Answer a few simple questions to find the government schemes you may qualify for. Takes less than 2 minutes.
            </p>
          </div>
          <Link
            to="/recommendations"
